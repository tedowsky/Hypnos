    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
                  ...
                  child: Column(
                    children: [
                      const ListTile(
                        ...
                        subtitle: Text(
                          'Il tempo di sonno effettivo è il tempo totale che hai trascorso a dormire durante la notte',
                      ...
                      const ListTile(
                        ...
                        subtitle: Text(
                          'Il tempo trascorso a letto è il periodo complessivo in cui sei rimasto a letto incluso il tempo impiegato per addormentarti',
                          selectionColor: Color(0xFFE4DFD4),
                        ),
                      ),
                      Align(
                              ...
                              Column(
                                children: [
                                  Text(
                                    _eff(eff),
                                    selectionColor:
                                        const Color.fromARGB(227, 152, 19, 19),
                                  ),
                                  IconButton(
                                    onPressed: () {
                                      showDialog(
                                    ...
                                    icon: const Icon(
                                      Icons.info_outline,
                                      color: Color.fromARGB(255, 228, 223, 20),
                                    ),
                                  ),
                                ],
                              ),
          ...
          SizedBox(height: 300, width: 500, child: GSIChart(gsi: 3)),
          Align(
              alignment: Alignment.center,
