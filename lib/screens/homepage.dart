          ...
          body: ListView(
            children: [
              ...
              SizedBox(
                ...
                child: Column(
                  children: [
                    Image.asset(imagePath,height: 75,width: 75,),
                    Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      LinearPercentIndicator(
                        ...
                        center: Text('${(sleep.minAsleep / sleep.timeInBed * 100).toStringAsFixed(0)}%'),
                        width: 210,
              ...
              Center(
                child: isCircularIndicatorVisible
                                ...
                                Column(
                                  children: [
                                    if (Provider.of<Preferences>(context,
                                          ...
                                          .age !=
                                      null)
                                    Text('Age: ${Provider.of<Preferences>(context, listen: false).age}'),
                                    const SizedBox(
                                      height: 10,
                                    ),
                                    Row(
                                      children: [
                                        ...
                                        Text(' ${DateFormat('HH:mm').format(sleep.endTime)}')
                                      ],
                                    ),
                                    const SizedBox(
                                      height: 10,
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(' ${DateFormat('HH:mm').format(sleep.startTime)}'),
                                      ],
                                    ),
                                    const SizedBox(
                                      height: 35,
                                    ...
                                    if (Provider.of<Preferences>(context,
                                          ...
                                          .age !=
                                      null)
                                    Text('GOAL:${goal(Provider.of<Preferences>(context, listen: false).age)} h'),
                                  ],
                                ),
                                const SizedBox(
                                  width: 40,
                    ...
                    : SizedBox(
                        height: 200, width: 300, child: Column(
                          children: [
                            Row(
                              children: [
                                    ...
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        content: Text(
                                          ...
                                          selectionColor: const Color(0xFFE4DFD4),
                                        ),
                                        actions: [
                                          Row(
                                            mainAxisAlignment:
