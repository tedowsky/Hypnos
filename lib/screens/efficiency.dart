      ...
      body: const SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10.0),
            Text('High sleep efficiency, therefore, indicates a quality rest period in which the time spent in bed is mostly devoted to actual sleep. On the other hand, low sleep efficiency could indicate problems such as insomnia, sleep apnea or other conditions that affect the quality of rest.\n\n Measuring sleep efficiency can be helpful in assessing the quality of your rest and identifying any sleep disorders you may be facing. You can use sleep tracking devices or apps that record your sleep patterns and provide an assessment of your sleep efficiency',
            style: TextStyle(
                fontSize: 15, 
              ),
            ),
